      ...
      <div class="row gx-5  mt-3 mb-3">
        <div class="col d-flex align-items-center justify-content-center ">
          <div class="p-3 " style="height: 100%; width: 100%;">
            <img src="login.svg" alt="Phone image" style="height:100%; width: 100%;">
          </div>
        </div>
        <div class="col">
          <div class="p-4 ">
            <form action="login.php" method="post">
              ...
              <div class="form-outline mb-4">
                ...
                <input type="email" required id="form1Example13" class="form-control form-control-lg py-3" name="username" autocomplete="off" placeholder="enter your e-mail" style="border-radius:25px ;" />
              ...
              <div class="form-outline mb-4">
                ...
                <input type="password" required id="form1Example23" class="form-control form-control-lg py-3" name="password" autocomplete="off" placeholder="enter your password" style="border-radius:25px ;" />
